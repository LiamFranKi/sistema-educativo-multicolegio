...
**MÓDULO DE CURSOS - ÁREAS CURRICULARES:** Implementación completa del CRUD para gestión de cursos con diseño consistente: header con icono `School`, título con formato estándar (Typography h4), búsqueda por nombre/descripción/abreviatura, filtros por nivel educativo y estado (Activo/Inactivo), botón "Nuevo Curso", tabla profesional con colores estándar (cabecera azul #61a7d1, filas alternadas blanco/#e7f1f8, hover naranja #ffe6d9), menú contextual estándar (Ver Detalle, Editar Curso, Eliminar Curso), formulario modal con subida de imágenes usando fileService, vista detallada en modal con información completa, validaciones robustas, y diseño uniforme con patrones establecidos del sistema.
