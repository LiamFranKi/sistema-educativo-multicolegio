...
// Páginas del Apoderado
import ApoderadoDashboard from '../../pages/Apoderado/ApoderadoDashboard';
import MisHijos from '../../pages/Apoderado/MisHijos';
import Publicaciones from '../../pages/Apoderado/Publicaciones';
import MiPerfil from '../../pages/MiPerfil';

// Componente de Sidebar
import ApoderadoSidebar from '../Sidebar/ApoderadoSidebar';

const ApoderadoLayout = ({ onLogout }) => {
